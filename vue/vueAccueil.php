<main>
    <div class="mainContentAccueil">
        <div>
            <div class="ContentAccueil CAsection1">
                <div class="photoProfilAccueil"></div>
            </div>
            <div class="ContentTypeText ContentAccueil CAsection2">
        ...
        <div class="ContentTypeText contentBtsSio backType1" >
            <img src="src/img/png/logo-btssio" alt="" class="btsLogo">
