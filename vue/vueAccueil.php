    ...
    <main>
        <div class="homeContent">
            <div>
                ...
                <div id="bts" class="borderfC fCWidth bfCTop btsLogoContent">
                    <img  src="src/img/png/logo-btssio.png" alt="" class="btsLogo">
                </div>
            </div>
            <div class="formationContent textContent fCWidth" >
            ...
            <div>
                <!-- <div class="demiCercleBande">
                    <div class="demiCercle DCleft"></div>
