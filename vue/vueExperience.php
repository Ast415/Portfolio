    <main>
        <div class="experiencesContent">
            <div class="aExpContent projetsContent" id="projets">
                ...
                <div class="aProjetContent pcContentYear1">
                    ...
                    <div class="cardContent">
                        <div class="Card shadowStyle1" id="glpiOut">
                        ...
                        <div class="Card shadowStyle1" id="gsbOut">
                            ...
                            <h3>GSB Projet APPLI-RAPPORTS</h3>
                            <div class="textCardContent">
                                <p>L'objectif était de concevoir une application web pour les visiteurs médicaux qui souhaitaient pouvoir présenter des produits, suivre les remplaçants et améliorer l'efficacité des comptes-rendus.</p>
                            </div>
                            <h4><a href="#gsb">En savoir +</a></h4>
                        </div>
                    </div>
                </div>
                <div class="aProjetContent pcContentYear2">
                    ...
                    <div class="cardContent">
                        ...
                        <div class="Card shadowStyle1" id="#crosOut">
                            <div class="imgContent">
            ...
            <div class="aExpContent" id="stages">
                <h1>Mes Stages</h1>
                <div class="stagesContent">
                    <div class="aStageContent scContentYear1">
                        <h2>Stage 1ere année</h2>
                        <div class="cardContent">
                            <div class="Card shadowStyle1" id="#chuOut">
                                <div class="imgContent">
                    ...
                    <div class="aStageContent scContentYear2">
                        <h2>Stage 2eme année</h2>
                        <div class="cardContent">
                            <div class="Card shadowStyle1" id="#cgxOut">
                                <div class="imgContent">
