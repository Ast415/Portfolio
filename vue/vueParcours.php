  <main>
    <div class="timeline">
      ...
      <div class="timeline-container left">
        ...
        <div class="content">
          <h2>Réoriantation vers un BAC Pro SN</h2>
          <p>
            Le choix de me rediriger vers un BAC PRO Système Numérique fut une bonne décision. J'ai pu trouver ma voix en devenant un technicien qui intervient sur les équipements et installations intégrant des technologies numériques.
          </p>
        </div>
      </div>
      <div class="timeline-container right">
        ...
        <div class="content">
          <h2>Obtention de mon BAC Pro SN</h2>
          <!-- <p>
            Lorem ipsum dolor sit amet elit. Aliquam odio dolor, id luctus erat sagittis non. Ut blandit semper pretium.
          </p> -->
        </div>
      ...
      <div class="timeline-container right">
        ...
        <div class="content">
          <h2>Objectif : obtenir mon BTS SIO</h2>
          <!-- <p>
            Lorem ipsum dolor sit amet elit. Aliquam odio dolor, id luctus erat sagittis non. Ut blandit semper pretium.
          </p> -->
        </div>
